...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                    <ul class="navbar-nav ms-auto1 mb-2 mb-lg-0 " >
                        ...
                        <form id="notification" action="Notification.jsp" method="post">
                        <li class="nav-item ms-3" style="font-weight: 600;">
        ...
        <div style="background-color:whitesmoke" class="mt-2">
            <form action="#" method="post" enctype="multipart/form-data">
                <!--<center> <input type="file" name="Myfile" class="custom-file-input">-->
                <!--<input class="custom-file-input" style="border-radius: 4px;   display: inline-block; background-color:#36a942; color: white; width: 100px; margin: 50px" type="submit" value="Upload" ></center>-->
                <main class="main_full">
                    <div class="container">
                        <div class="panel">
                            <div class="button_outer">
                                <div class="btn_upload a">
                                    <a href=" http://localhost:8501/ " target="_blank" >Tap to check the product is Recyclable or Not</a>	
                                </div>
                            </div>
        ...
        <div  id="carouselExampleCaptions" class="carousel slide mt-3" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" style="height: 575px">
                <div class="carousel-item active">
                    <img src="Media/Slide_3.png" class="d-block w-100" alt="..." height="700vh" width="10px">
                ...
                <div class="carousel-item">
                    <img src="Media/Slide_1.png" class="d-block w-100" alt="..." height="800px" width="10px">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="Media/battery.jpeg" class="d-block w-100" alt="..." height="700vh" width="10px">
                    <div class="carousel-caption d-none d-md-block">
