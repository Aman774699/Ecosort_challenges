 ...
 * @author ASUS
 */
public class Update_Profile_picture extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Update_Profile_picture</title>");
            out.println("</head>");
            out.println("<body>");
            HttpSession session = request.getSession();
            String email = session.getAttribute("Email").toString();
            String username, MOBILE_NO, Current_Location;
            ...
            GEP.setMobileNO(MOBILE_NO);
            GEP.setUsername(username);
            GEP.setLocation(Current_Location);
            if (EPU.updatedetails(GEP, email)) {
