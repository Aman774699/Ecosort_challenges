...
public class Enter_NewPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Enter_NewPassword</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if (reg.updatepassword(email, password)&&reg.updatepassword1(email, password)) {
